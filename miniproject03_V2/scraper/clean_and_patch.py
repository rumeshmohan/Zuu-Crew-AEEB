...
SAVE_EVERY = 50   # checkpoint frequency — balances safety vs I/O overhead
...
def save_catalog(catalog: list[dict]) -> None:
    """
    Atomically persist the catalog to CATALOG_PATH.
...
def run_pipeline():
    ...
    for idx, item in enumerate(tqdm(catalog, desc="Refining Catalog")):
